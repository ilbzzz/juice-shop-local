...
export const isRedirectAllowed = (url: string) => {
  ...
  for (const allowedUrl of redirectAllowlist) {
    allowed = allowed || url === allowedUrl || utils.startsWith(url, allowedUrl + '/') || utils.startsWith(url, allowedUrl + '?') || utils.startsWith(url, allowedUrl + '#') // vuln-code-snippet vuln-line redirectChallenge
  }
  return allowed
}
