...
export async function parseXmlString (data: string, timeoutMs = 2000): Promise<string> {
  ...
  const option = libxml2.ParseOption.XML_PARSE_NOENT | libxml2.ParseOption.XML_PARSE_NOBLANKS | libxml2.ParseOption.XML_PARSE_NOCDATA | libxml2.ParseOption.XML_PARSE_NO_XXE
