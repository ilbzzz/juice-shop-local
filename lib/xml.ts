...
// Parses XML with external entity loading disabled to prevent XXE vulnerabilities.
// The parse runs in a vm context with a timeout so entity-expansion bombs surface
